...
python train.py --train_json_data data/newdata_cls_train_vidsplit.json --eval_json_data data/newdata_cls_val_vidsplit.json --img_dir /mydata/vocim/shared/KeypointAnnotations 2>&1 | tee $LOG_FILE
